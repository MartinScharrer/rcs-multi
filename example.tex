...
\rcsid{$Id: example.tex,v 1e95774a3ec5 2012/03/29 09:57:58 martin $}
% or, alternatively, with full path:
\rcsid{$Header: /home/martin/wd/rcs-multi/example.tex,v 1e95774a3ec5 2012/03/29 09:57:58 martin $}

% Other keywords can be read using:
\rcskwsave{$Author: martin $}
\rcskwsave{$Date: 2012/03/29 09:57:58 $}
\rcskwsave{$Name:  $}
% The `Log' keyword is not supported.
\rcskwsave{$Locker: martin $}
\rcskwsave{$RCSfile: example.tex,v $}
\rcskwsave{$Revision: 1e95774a3ec5 $}
\rcskwsave{$Source: /home/martin/wd/rcs-multi/example.tex,v $}
\rcskwsave{$State: Exp $}
