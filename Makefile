...
LTXFILES      = ${CONTRIBUTION}.sty rcs-multi-hg.sty
...
CTANFILES     = ${DTXFILES} ${INSFILES} ${LTXDOCFILES} ${PLAINDOCFILES} ${GENDOCFILES} ${SCRDOCFILES} rcs-multi-hg.sty
...
${BUILDDIR}: ${MAINFILES}
	...
	cp ${INSFILES} rcs-multi-hg.sty README ${BUILDDIR}/
